    ...
    <div className="min-h-screen py-6 sm:py-12 px-4 sm:px-6 lg:px-8 mt-12">
      ...
      <main className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden w-full">
        <div className="p-6 sm:p-8">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-6 sm:mb-8">
            Решайте задачи с ИИ
          </h1>
          ...
          {isLoading && (
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                ИИ пытается решить ваши задачи...
              </p>
            </div>
          )}
          ...
          {solutions.length > 0 && (
            <div className="space-y-6">
              {solutions.map((solution, index) => (
                <div
                  key={index}
                  className="bg-gray-50 rounded-lg p-4 sm:p-6 shadow-inner"
                >
